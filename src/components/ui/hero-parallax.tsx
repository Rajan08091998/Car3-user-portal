...
export const Header = ({
  ...
  return (
    <div className="w-full text-center relative mx-auto py-20  md:py-40 px-4 left-0 top-0 flex flex-col justify-center items-center">
      <h1 className="text-4xl md:text-7xl font-bold dark:text-white">
        {info.title}
      </h1>
      <p className="text-xl text-center max-w-4xl md:text-xl mt-4 dark:text-neutral-200">
        {info.subtitle}
      </p>
    </div>
  );
